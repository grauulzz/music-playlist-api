...
class UpdatePlaylistActivityTest {
    @Mock
    ...
    @Test
    void handleRequest_goodRequest_updatesPlaylistName() {
        // GIVEN
        String id = "id";
    ...
    @Test
    void handleRequest_customerIdNotMatch_throwsInvalidAttributeChangeException() {
        // GIVEN
        String id = "id";
        UpdatePlaylistRequest request = UpdatePlaylistRequest.builder()
                                            .withId(id)
