...
class AddSongToPlaylistActivityTest {
    @Mock
    ...
    void handleRequest_validRequest_addsSongToEndOfPlaylist() {
        ...
        // WHEN
        AddSongToPlaylistResult result = addSongToPlaylistActivity
    ...
    @Test
    void handleRequest_noMatchingPlaylistId_throwsPlaylistNotFoundException() {
        // GIVEN
    ...
    @Test
    void handleRequest_noMatchingAlbumTrack_throwsAlbumTrackNotFoundException() {
        // GIVEN
        ...
        when(albumTrackDao.getAlbumTrack(asin, trackNumber))
                .thenThrow(new AlbumTrackNotFoundException());
